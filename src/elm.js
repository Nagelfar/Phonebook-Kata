...
var $author$project$Code$ShouldList = function (a) {
	return {$: 'ShouldList', a: a};
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$File$load = _Platform_outgoingPort('load', $elm$json$Json$Encode$string);
...
var $author$project$Code$parseFileParameters = function (_arguments) {
	var _v0 = A2($elm$core$String$split, ' ', _arguments);
	if (_v0.b) {
		var fileName = _v0.a;
		var rest = _v0.b;
		return $elm$core$Result$Ok(
		...
		return $elm$core$Result$Err('Could not parse filename from arguments: ' + _arguments);
	}
};
var $author$project$Code$ShouldAdd = F2(
	function (a, b) {
		return {$: 'ShouldAdd', a: a, b: b};
	});
var $elm$core$String$toInt = _String_toInt;
var $author$project$Code$parsePhonebookArguments = function (_arguments) {
	var _v0 = A2($elm$core$String$split, ' ', _arguments);
	_v0$3:
	while (true) {
		if (_v0.b) {
			if (!_v0.b.b) {
				if (_v0.a === 'list') {
					return $elm$core$Result$Ok(
						$author$project$Code$ShouldList($elm$core$Maybe$Nothing));
				} else {
					break _v0$3;
				}
			} else {
				if (_v0.b.b.b) {
					if ((_v0.a === 'add') && (!_v0.b.b.b.b)) {
						var _v1 = _v0.b;
						var name = _v1.a;
						var _v2 = _v1.b;
						var number = _v2.a;
						return $elm$core$Result$Ok(
							A2($author$project$Code$ShouldAdd, name, number));
					} else {
						break _v0$3;
					}
				} else {
					if (_v0.a === 'list') {
						...
						var number = _v3.a;
						return $elm$core$Result$Ok(
							$author$project$Code$ShouldList(
	...
	return $elm$core$Result$Err('Could not parse arguments ' + _arguments);
};
var $author$project$Code$parseModel = function (_arguments) {
	return A2(
		$elm$core$Result$andThen,
		function (_v0) {
			var fileName = _v0.a;
			var remainingArguments = _v0.b;
			return A2(
				$elm$core$Result$map,
				function (operation) {
					return {fileName: fileName, operation: operation};
				},
				$author$project$Code$parsePhonebookArguments(remainingArguments));
		},
...
var $author$project$Code$init = F2(
	function (flags, _v0) {
		...
		var _v1 = $author$project$Code$parseModel(
			A2($elm$core$String$join, ' ', _arguments));
		if (_v1.$ === 'Ok') {
			var model = _v1.a;
			return _Utils_Tuple2(
				model,
				$author$project$File$load(model.fileName));
		} else {
			var e = _v1.a;
			return _Utils_Tuple2(
				{
					fileName: e,
					operation: $author$project$Code$ShouldList($elm$core$Maybe$Nothing)
				},
				$author$project$Ports$printAndExitFailure(e));
		}
	});
...
var $author$project$File$FileLoaded = function (a) {
...
var $author$project$Code$addToPhonebook = F2(
	function (book, entry) {
		return A2($elm$core$List$cons, entry, book);
	});
var $author$project$Code$asEntry = function (line) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
		...
		var e = _v0;
		return $elm$core$Result$Err(
			'Could not parse entry from: ' + A2($elm$core$String$join, ' ', e));
	}
};
...
var $author$project$Code$parsePhonebookFromContent = function (file) {
	return A2(
		...
		A3(
			...
			F2(
				function (item, state) {
					var _v0 = _Utils_Tuple2(item, state);
					if (_v0.a.$ === 'Ok') {
						if (_v0.b.$ === 'Ok') {
							var entry = _v0.a.a;
							var book = _v0.b.a;
							return $elm$core$Result$Ok(
								A2($author$project$Code$addToPhonebook, book, entry));
						} else {
							var errors = _v0.b.a;
						...
						if (_v0.b.$ === 'Ok') {
							...
							var errors = _v0.b.a;
							return $elm$core$Result$Err(
								A2($elm$core$List$cons, e, errors));
						}
					}
				}),
			...
			A2(
				$elm$core$List$map,
				$author$project$Code$asEntry,
				A2(
					$elm$core$List$filter,
					A2($elm$core$Basics$composeR, $elm$core$String$isEmpty, $elm$core$Basics$not),
					A2($elm$core$String$split, '\n', file)))));
};
var $author$project$Code$Added = function (a) {
	return {$: 'Added', a: a};
};
var $author$project$Code$Listed = function (a) {
	return {$: 'Listed', a: a};
};
var $author$project$Code$listItems = F2(
	function (count, book) {
		return A2(
			$elm$core$String$join,
			'\n',
...
var $author$project$Code$phonebook = F2(
	function (operation, book) {
		if (operation.$ === 'ShouldAdd') {
			var name = operation.a;
			var number = operation.b;
			return $author$project$Code$Added(
				A2(
					$author$project$Code$addToPhonebook,
					book,
					{name: name, number: number}));
		} else {
			var count = operation.a;
			return $author$project$Code$Listed(
				A2($author$project$Code$listItems, count, book));
		}
	});
...
var $author$project$File$save = _Platform_outgoingPort(
	'save',
	function ($) {
...
var $author$project$Code$writePhonebookToFile = F2(
	function (filename, book) {
		return $author$project$File$save(
			{
				content: A2($author$project$Code$listItems, $elm$core$Maybe$Nothing, book),
				fileName: filename
			});
	});
var $author$project$Code$update = F3(
	function (_v0, msg, model) {
		if (msg.$ === 'NoOp') {
			...
			var content = msg.a.a;
			var phonebookContent = $author$project$Code$parsePhonebookFromContent(content);
			return _Utils_Tuple2(
				model,
				function () {
					var _v2 = A2(
						$elm$core$Result$map,
						$author$project$Code$phonebook(model.operation),
						phonebookContent);
					if (_v2.$ === 'Ok') {
						if (_v2.a.$ === 'Added') {
						...
						var e = _v2.a;
						return $author$project$Ports$printAndExitFailure(e);
					}
				}());
		}
	});
